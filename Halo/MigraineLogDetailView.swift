...
struct MigraineLogDetailView: View {
        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 24) {
                ...
                VStack(alignment: .leading, spacing: 24) {
                    ...
                    infoCard(label: "Duration", content: durationText)
                    
                    infoCard(label: "Aura status", content: auraText)
                    
                    infoCard(label: "Pain intensity", content: intensityText)
                    
                    infoCard(label: "Possible causes", content: causesText)
                    
                    infoCard(label: "Locations", content: locationsText)
                    
                    infoCard(label: "Medication taken", content: medicationTakenText)
    ...
    private var logDateText: String {
        episode.occurredAt?.formatted(date: .abbreviated, time: .omitted) ?? "Not set"
    }
    
    private var logTimeText: String {
        episode.occurredAt?.formatted(date: .omitted, time: .shortened) ?? "Not set"
    }
    ...
    private var auraText: String {
        episode.auraEnum?.label ?? "Not set"
    }
    
    private var intensityText: String {
        episode.painIntensityEnum?.label ?? "Not set"
    }
    ...
    private var medicationTakenText: String {
        episode.medicationTakenEnum?.label ?? "Not set"
    }
...
#Preview {
    ...
    episode.migraineType = MigraineType.active.rawValue
